...
// Copia aquí los valores de: Supabase > Project Settings > API Keys
//
// · SUPABASE_URL: la URL del proyecto (https://xxxx.supabase.co)
// · SUPABASE_KEY: la clave PÚBLICA ("publishable" o "anon").
//   Es pública por diseño: la protección la dan RLS y las funciones.
//
